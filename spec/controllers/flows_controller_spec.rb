...
describe FlowsController, :type => :controller do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved flow as @flow" do
        post :create, {:flow => invalid_attributes}, valid_session
        expect(assigns(:flow)).to be_a_new(Flow)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested flow" do
        flow = Flow.create! valid_attributes
        put :update, {:id => flow.to_param, :flow => new_attributes}, valid_session
        flow.reload
    ...
    describe "with invalid params" do
      it "assigns the flow as @flow" do
        flow = Flow.create! valid_attributes
        put :update, {:id => flow.to_param, :flow => invalid_attributes}, valid_session
        expect(assigns(:flow)).to eq(flow)
      end
